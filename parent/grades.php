    ...
    <?php if ($selectedClassId && !empty($grades)): ?>
        ...
        <div class="card shadow mb-lg">
            <div class="card__title d-flex justify-between items-center">
                ...
                <span class="grade <?= $classAverage >= 4 ? 'grade-5' : ($classAverage >= 2.5 ? 'grade-3' : 'grade-1') ?>">
                            ...
                            <?php foreach ($subject['grade_items'] as $item): ?>
                                <?php if (isset($item['points'])): ?>
                                    <tr>
                                        ...
                                        <td>
                                        <span class="grade <?= ($item['points'] / $item['max_points']) * 100 >= 90 ? 'grade-5' : (($item['points'] / $item['max_points']) * 100 >= 50 ? 'grade-3' : 'grade-1') ?>">
            ...
            <div class="card__content">
                ...
                <div class="d-flex flex-column gap-md">
                    <?php foreach ($gradeGroups as $grade => $count): ?>
                        ...
                        $barClass = $grade >= 4 ? 'grade-5' : ($grade >= 3 ? 'grade-3' : 'grade-1');
                        ?>
                        <div>
